...
public class IO {
    ...
    /**
     * The script facfory instance
     */
    private static ScriptFactory scriptFactory = new ScriptFactory();
    ...
    public static Script read(Reader r) throws IOException, JSONException {
        return scriptFactory.parse(new JSONObject(new JSONTokener(r)));
    }
    ...
    public static Script read(String s) throws IOException, JSONException {
        return scriptFactory.parse(new JSONObject(new JSONTokener(s)));
    }
}
