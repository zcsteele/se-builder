...
fxdriver.cache.addElement = function(a) {
  var b = new XPCNativeWrapper(a.ownerDocument), a = a.tagName == goog.dom.TagName.IFRAME || a.tagName == goog.dom.TagName.FRAME ? a : new XPCNativeWrapper(a), b = fxdriver.moz.unwrap(goog.dom.getWindow(b)), c = b.fxdriver_id;
